...
5. **One task, one commit.** Plan tasks land as separate commits (Plan 01-01 = 3 tasks = 3 commits: `aa06754`, `f254e00`, `e4e2398`), so a regression bisects to a task, not to a week of work. Never mix a mechanical change (rename, format) with a behavioral one.
